  ...
  return (
    <svg {...BASE} {...props}>
      ...
      <g strokeLinejoin="round" strokeLinecap="round">
        <rect x="58" y="30" width="110" height="136" rx="14" className="fill-white stroke-ink" strokeWidth="3.5" />
        <rect x="58" y="30" width="110" height="26" rx="14" className="fill-sun stroke-ink" strokeWidth="3.5" />
        <rect x="58" y="44" width="110" height="12" className="fill-sun" />
        <path d="M58 56 H168" className="stroke-ink" strokeWidth="3.5" />
        {/* date tag */}
        <path d="M76 43 H104" className="stroke-ink" strokeWidth="4" />
        {/* body lines */}
      ...
      <g transform="translate(118 138) rotate(32)" strokeLinejoin="round">
        <rect x="-8" y="-58" width="16" height="12" rx="3" className="fill-coral stroke-ink" strokeWidth="3" />
        <rect x="-8" y="-48" width="16" height="6" className="fill-white stroke-ink" strokeWidth="3" />
        <rect x="-8" y="-42" width="16" height="42" className="fill-sun stroke-ink" strokeWidth="3" />
        <path d="M-8 0 L8 0 L0 16 Z" className="fill-cream stroke-ink" strokeWidth="3" />
        <path d="M-3.5 10 L3.5 10 L0 16 Z" className="fill-ink" />
      </g>
  ...
  return (
    <svg {...BASE} {...props}>
      ...
      <g clipPath="url(#ob-capsule-clip)">
        ...
        <path d="M82 92 H158 M82 108 H158" className="stroke-ink" strokeWidth="3.5" />
        {/* shine */}
      ...
      <rect x="82" y="24" width="76" height="152" rx="38" className="stroke-ink" strokeWidth="3.5" />

      {/* padlock */}
      <g strokeLinejoin="round" strokeLinecap="round">
        <path d="M110 92 V84 a10 10 0 0 1 20 0 V92" className="stroke-ink" strokeWidth="4" />
        <rect x="102" y="90" width="36" height="30" rx="8" className="fill-white stroke-ink" strokeWidth="3.5" />
        <circle cx="120" cy="103" r="4" className="fill-ink" />
        <path d="M120 105 V112" className="stroke-ink" strokeWidth="3.5" />
      </g>
  ...
  return (
    <svg {...BASE} {...props}>
      ...
      <g transform="translate(120 92)">
        ...
        <circle r="42" className="fill-sun stroke-ink" strokeWidth="3.5" />
      </g>

      {/* letter rising out of the capsule */}
      <g strokeLinejoin="round" strokeLinecap="round">
        <rect x="94" y="62" width="52" height="76" rx="8" className="fill-white stroke-ink" strokeWidth="3.5" />
      ...
      <g strokeLinejoin="round">
        <path
          ...
          strokeWidth="3.5"
        />
        <rect x="68" y="124" width="104" height="14" rx="7" className="fill-sun stroke-ink" strokeWidth="3.5" />
